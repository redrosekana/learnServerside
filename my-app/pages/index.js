...
/* ทำความเข้าใจหน้านี้คือ เมื่อมีการ re-render โดย state ก็จะมีการเริ่มกำหนดค่า
  n ใหม่ ทุกครั้ง ให้เข้าใจได้เลยว่าจะเริ่มที่ 15 ทุกครั้งแม้จะบวกไปเท่าไหร่ก็ตาม โดย
  ค่าที่บวกไม่มีผลต่อตัวที่กำหนดไว้ ไม่ว่าจะ let หรือ const โดยจะไม่เกี่ยวข้องกับที่กำหนดเลย
  ...
  return (
    <>
      ...
      <div className='text-center'>
        ...
        <button className='btn btn-success' onClick={() => setM(m+1)}>เคลียร์</button>
      </div>
    </>
  )
}
